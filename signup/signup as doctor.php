...
// $role=$_POST['n1'];
if ($pass==$rpass) {
    $sql="INSERT INTO doctor (name,dob,mail,docid,address,phno,qualification,department,uname,pass) VALUES ('$name','$dob','$mail','$docid','$address','$phno','$qualification','$department','$uname','$pass')";

    if (mysqli_query($conn, $sql)) {
        echo"<script type='text/javascript'>window.alert('successfully completed');window.location='signup as doctor.html';</script>";
    } else {
