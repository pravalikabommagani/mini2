...
// $role=$_POST['n1'];
if ($pass==$rpass) {
    $sql="INSERT INTO patients (name,dob,mail,uname,password) VALUES ('$name','$dob','$mail','$uname','$pass')";

    if (mysqli_query($conn, $sql)) {
        echo"<script type='text/javascript'>window.alert('Successfully Completed');window.location='signup as patient.html';</script>";
    } else {
