...
INSERT INTO `appointments` (`id`, `date`, `time`, `username`, `doctorname`, `disease`) VALUES
...
INSERT INTO `doctor` (`name`, `dob`, `mail`, `docid`, `address`, `phno`, `qualification`, `department`, `uname`, `pass`) VALUES
...
INSERT INTO `patients` (`name`, `dob`, `mail`, `uname`, `password`) VALUES
